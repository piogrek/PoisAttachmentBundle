...
class UploadHandler
{
    ...
    protected function create_scaled_image($file_name, $version, $options) {
        ...
        $scale = min(
            isset($options['max_width'])?$options['max_width'] / $img_width:1,
            isset($options['max_height'])?$options['max_height'] / $img_height:1
        );
        if ($scale >= 1) {
    ...
    protected function generate_response($content, $print_response = true) {
        if ($print_response) {
            ...
            die($json); //pg not trying to understand what's after this line, not using anyway and not working for me
